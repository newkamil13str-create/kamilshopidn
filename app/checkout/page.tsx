...
export default function CheckoutPage() {
  ...
  const { selectedProduct, quantity, topupGameData, clearCheckout } = useCheckoutStore();
    ...
    try {
      ...
      const res = await fetch('/api/create-payment', {
        ...
        body: JSON.stringify({
          ...
          // ─── Topup game fields ───
          ...(item.product.productType === 'topup-game' && {
            productType: 'topup-game',
            gameName: item.product.gameName,
            qiospayProduct: item.product.qiospayProduct,
            gameDestination: topupGameData?.gameDestination,
            gameZoneId: topupGameData?.gameZoneId || null,
          }),
        }),
      });
